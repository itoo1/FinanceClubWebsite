...
const MEMBERS = [
  ...
  { id:7,  name:'Antonia Silva',     role:'Miembro Honorario',  career:'Contabilidad',         year:'3.º', area:'M&A / Valoración',     avatar:'AS', bio:'Especialista en modelos de valoración DCF y análisis de fusiones y adquisiciones.' },
  { id:8,  name:'Fernanda Molina',   role:'Miembro Honorario',  career:'Economía',             year:'4.º', area:'Renta Variable',       avatar:'FM', bio:'Análisis fundamental de empresas de consumo masivo y retail latinoamericano.' },
  { id:9,  name:'Andrés Castillo',   role:'Miembro Honorario',  career:'Ingeniería Comercial', year:'4.º', area:'Macro & FX',           avatar:'AC', bio:'Estrategia macroeconómica y posicionamiento en divisas de mercados emergentes.' },
  { id:10, name:'Nicolás Bravo',     role:'Miembro Honorario',  career:'Ingeniería Comercial', year:'3.º', area:'Renta Fija',           avatar:'NB', bio:'Análisis de instrumentos de deuda y estructura de curvas soberanas.' },
